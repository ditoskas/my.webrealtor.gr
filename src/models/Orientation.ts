...
type IOrientationModel = Model<IOrientation>;

const orientationSchema = new Schema<IOrientation, IOrientationModel>(
  {
...
export const Orientation =
  (mongoose.models.Orientation as IOrientationModel) ||
  mongoose.model<IOrientation, IOrientationModel>("Orientation", orientationSchema);
