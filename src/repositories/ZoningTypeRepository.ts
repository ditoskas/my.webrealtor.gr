import { ZoningType, type IZoningType } from "@/models/ZoningType";
import { BaseRepository } from "./BaseRepository";

class ZoningTypeRepository extends BaseRepository<IZoningType> {
  constructor() {
    super(ZoningType);
  }
...
export const zoningTypeRepository = new ZoningTypeRepository();
