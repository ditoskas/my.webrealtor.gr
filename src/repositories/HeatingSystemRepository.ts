import { HeatingSystem, type IHeatingSystem } from "@/models/HeatingSystem";
import { BaseRepository } from "./BaseRepository";

class HeatingSystemRepository extends BaseRepository<IHeatingSystem> {
  constructor() {
    super(HeatingSystem);
  }
...
export const heatingSystemRepository = new HeatingSystemRepository();
