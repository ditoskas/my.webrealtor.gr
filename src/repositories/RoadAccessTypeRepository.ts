import { RoadAccessType, type IRoadAccessType } from "@/models/RoadAccessType";
import { BaseRepository } from "./BaseRepository";

class RoadAccessTypeRepository extends BaseRepository<IRoadAccessType> {
  constructor() {
    super(RoadAccessType);
  }
...
export const roadAccessTypeRepository = new RoadAccessTypeRepository();
