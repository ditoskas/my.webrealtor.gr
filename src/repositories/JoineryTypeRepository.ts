import { JoineryType, type IJoineryType } from "@/models/JoineryType";
import { BaseRepository } from "./BaseRepository";

class JoineryTypeRepository extends BaseRepository<IJoineryType> {
  constructor() {
    super(JoineryType);
  }
...
export const joineryTypeRepository = new JoineryTypeRepository();
