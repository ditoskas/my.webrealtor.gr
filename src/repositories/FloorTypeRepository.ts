import { FloorType, type IFloorType } from "@/models/FloorType";
import { BaseRepository } from "./BaseRepository";

class FloorTypeRepository extends BaseRepository<IFloorType> {
  constructor() {
    super(FloorType);
  }
...
export const floorTypeRepository = new FloorTypeRepository();
