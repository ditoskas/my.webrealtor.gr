import { HeatingMedium, type IHeatingMedium } from "@/models/HeatingMedium";
import { BaseRepository } from "./BaseRepository";

class HeatingMediumRepository extends BaseRepository<IHeatingMedium> {
  constructor() {
    super(HeatingMedium);
  }
...
export const heatingMediumRepository = new HeatingMediumRepository();
