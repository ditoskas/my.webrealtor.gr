import { GlassType, type IGlassType } from "@/models/GlassType";
import { BaseRepository } from "./BaseRepository";

class GlassTypeRepository extends BaseRepository<IGlassType> {
  constructor() {
    super(GlassType);
  }
...
export const glassTypeRepository = new GlassTypeRepository();
