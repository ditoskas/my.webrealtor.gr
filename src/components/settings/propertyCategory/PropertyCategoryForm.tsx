...
import type { PropertyCategoryInput } from "@/lib/types";
import sharedStyles from "@/styles/shared.module.scss";

const EMPTY_VALUES: PropertyCategoryInput = {
  name: "",
  slug: "",
};

interface PropertyCategoryFormProps {
  initialValues?: Partial<PropertyCategoryInput>;
  submitLabel: string;
  loading?: boolean;
  error?: string | null;
  onSubmit: (values: PropertyCategoryInput) => void;
  onCancel: () => void;
}
...
export default function PropertyCategoryForm({
  ...
  const [values, setValues] = useState<PropertyCategoryInput>({ ...EMPTY_VALUES, ...initialValues });
